...
def load_dataset(args):
    ...
    elif dataset_name in ('cora', 'citeseer', 'pubmed', 'amazon-photo', 'amazon-computer', 'coauthor-cs', 'coauthor-physics'):
        dataset_ind, dataset_ood_tr, dataset_ood_te = load_graph_dataset(args.data_dir, dataset_name, args.ood_type)
...
def load_arxiv_dataset(data_dir, time_bound=[2015,2017], inductive=True):
    ...
    year = torch.as_tensor(ogb_dataset.graph['node_year']).reshape(-1, 1)
