...
def should_eval(epoch, args):
    return epoch == args.epochs - 1 or epoch % args.eval_step == 0
...
try:
    ...
    print('Interrupted. Cleaning up GPU memory before exit...')
